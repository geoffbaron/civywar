...
export const BATTLEFIELDS = {
  antietam: {
    ...
    mission: 'Hold the most flags when the sun sets — or break the Army of Northern Virginia.',
    duration: 360,
  ...
  gettysburg: {
    ...
    mission: 'Control the high ground — hold the most flags when the battle clock runs out.',
    duration: 420,
...
OBJECTIVE: Repel Pickett's Charge. Hold The Angle (center fort). Stuart's cavalry must not break through to your rear.`,
  ...
  chancellorsville: {
    ...
    mission: 'Hold the most flags when time expires — beware the flank march through the Wilderness.',
    duration: 360,
  ...
  shiloh: {
    ...
    mission: 'Survive the surprise attack — hold the most flags when the clock runs out.',
    duration: 360,
